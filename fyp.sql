...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2023 at 04:18 PM
...
(45, 'asd@gmail.com', 1, 1, 1, 2, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '2023-06-07 11:47:05');
...
(33, 92, 'Adidas Ultraboost', '7', 1, '150.00', 'chorxiang@gmail.com', 29, 'Delivering', '2023-05-30', 'adidas.png', 'a', 'chorxiang@gmail.com', '0123456789', '12, Jalan haha, Taman haha ,Semabok', 'melaka', '12345', '1111222244445555', 'Ali', '01', '23', '123', 210),
(34, 92, 'Taylor All Star', '7', 1, '60.00', 'chorxiang@gmail.com', 29, 'Delivering', '2023-05-30', 'convers.png', 'a', 'chorxiang@gmail.com', '0123456789', '12, Jalan haha, Taman haha ,Semabok', 'melaka', '12345', '1111222244445555', 'Ali', '01', '23', '123', 210);
...
(21, 'a', '456@gmail.com', 'after', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaasaaaaaaaaaaa');
...
INSERT INTO `shoes` (`shoe_id`, `shoe_name`, `shoe_type`, `shoe_brand`, `category`, `shoe_image`, `shoe_price`, `status`, `yn`) VALUES
(1, 'Nike Air Max 90', 'Running Shoes', 'test', 'men', 'nike_air_max_90.png', '111.00', 'active', 'y'),
(2, 'Adidas Ultraboost', 'Running Shoes', 'Adidas', 'women', 'adidas.png', '149.99', 'active', 'y'),
(3, 'Taylor All Star', 'Running Shoes', 'Converse', 'men', 'convers.png', '59.99', 'inactive', 'y'),
(4, 'Puma Suede Classic', 'Sneakers', 'Puma', 'men', 'puma.png', '79.99', 'active', 'y'),
(6, 'Air Jordan', 'lifestyle', 'Nike', 'women', 'jordan.png', '420.00', 'active', 'y'),
(8, 'Nike Invincible 3', 'Running Shoes', 'Nike', 'men', 'invincible3.png', '799.00', 'active', 'y'),
(9, 'Nike Air Force', 'Lifestyle', 'Nike', 'men', 'airforce.png', '489.00', 'active', 'y'),
(10, 'Adidas Ultra 4D', 'Running Shoes', 'Adidas', 'men', 'ultra.png', '274.75', 'active', 'y'),
(20, '', '', 'ttt', 'men', '', '0.00', 'active', 'n');
...
(2, 'abcccccccccc', '0123456700', '456@gmail.com', '123', '234', '234', 'profile.jpg', 'active'),
(29, 'Ali', '01123654987', 'ali@gmail.com', 'Ali2', 'Qwe12#', 'Qwe12#', 'profile.jpg', 'active'),
(31, 'a', '0123456789', 'bba712412@gmail.com', '', 'Qwe12#', 'Qwe12#', 'profile.jpg', 'active');
...
(69, 'Nike Air Max 90', '111.00', '7', 1, 1, 2, 'nike_air_max_90.png', 'active', 'test'),
(70, 'Nike Air Max 90', '111.00', '7', 1, 1, 27, 'nike_air_max_90.png', 'active', 'test'),
...
--
ALTER TABLE `orders`
  MODIFY `order_ID` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=317;
...
--
ALTER TABLE `shoes`
  MODIFY `shoe_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
