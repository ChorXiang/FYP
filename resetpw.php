    ...
    <body>
        <div class="box">
            <div class="center2">
                ...
                <form name="resetpwfrm" method="POST" action="resetpw.func.php" autocomplete="off">
                <div class="coninput">
                <p><input placeholder="Password" name="pw" type="password" class="input-field" id="pw"></p>

                <input type="checkbox" onclick="showpw()"><span class="showpw">Show Password</span>
                ...
                <p><input placeholder="Confirm password" name="cpw" type="password" class="input-field" id="cpw"></p>

                <input type="checkbox" onclick="showconpw()"><span class="showpw">Show Password</span>
                ...
                <br><br>
                <div class="btn">
                <input class="verifybtn" type="submit" name="resetbtn" value="RESET PASSWORD"><br>
                <br>
                <span style="color:red; font-size:12px;"> <?php echo $invalidreset; ?></span>
                </div>
                </form>   
            </div>
        </div>
